...
function RobloxCard({ data }: any) {
  ...
  return (
    <div style={{ ...neu2, marginTop: '12px', textAlign: 'center' }}>
      ...
      <div style={{ color: '#888', fontSize: '12px', marginBottom: '4px' }}>@{d.username}</div>
      {d.is_banned && <div style={{ color: '#f44', fontSize: '11px', marginBottom: '4px' }}>🔨 Banned</div>}
      ...
      <div style={{ fontSize: '11px', color: '#888', marginBottom: '8px' }}>📅 {d.created}</div>
  ...
  return (
    <main style={{ minHeight: '100vh', background: '#e0e5ec', fontFamily: 'system-ui, sans-serif', padding: '24px 16px' }}>
      ...
      <div style={neu}>
        ...
        <div style={neu2}>GET /api/nglspam?username=eguu&pesan=hai&jumlah=5</div>
      ...
      <div style={neu}>
        <div style={{ display: 'flex', alignItems: 'center', gap: '10px', marginBottom: '16px' }}>
          ...
          <span style={{ marginLeft: 'auto', fontSize: '11px', color: '#999' }}>Stalk Roblox</span>
        </div>
        <p style={{ fontSize: '12px', color: '#888', marginBottom: '16px' }}>Ambil info publik akun Roblox lengkap dengan avatar</p>
        <div style={neu2}>GET /api/stalkroblox?username=Builderman</div>
        <div style={{ display: 'flex', flexDirection: 'column', gap: '14px' }}>
          <div>
